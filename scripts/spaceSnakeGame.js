// Space Snake Game - Classic snake in space
// Mikky Studio - 2025
...
class SpaceSnakeGame {
    ...
    initializeGame() {
        ...
        this.spawnFood();
        this.updateUI();
        console.log('Space Snake initialized');
    }
    ...
    moveSnake() {
        ...
        if (foodIndex !== -1) {
            ...
            if (food.type === 'normal') {
                ...
                this.score += 25;
                this.moveInterval = Math.max(50, this.moveInterval - 5); // Speed up
            }
            
            // Level up every 10 food
            if (this.score % 100 === 0) {
                this.level++;
                this.moveInterval = Math.max(50, this.moveInterval - 10);
            }
    ...
    render() {
        ...
        this.powerUps.forEach(powerUp => {
            let color;
            switch(powerUp.type) {
                case 'slow': color = '#a8e6cf'; break;
                case 'shrink': color = '#ffd93d'; break;
                case 'score': color = '#ffaaa5'; break;
            }
